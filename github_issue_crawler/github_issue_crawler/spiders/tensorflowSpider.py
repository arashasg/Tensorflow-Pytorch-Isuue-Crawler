...
class TensorflowSpider(scrapy.Spider):
    name = "tensorflowSpyder"
    # start_urls = [
    #     'https://github.com/tensorflow/tensorflow/issues/58600',
    #     'https://github.com/tensorflow/tensorflow/issues/58601',
    #     'https://github.com/tensorflow/tensorflow/issues/58602',
    #     'https://github.com/tensorflow/tensorflow/issues/58538',
    #     'https://github.com/tensorflow/tensorflow/issues/5010',
    #     'https://github.com/tensorflow/tensorflow/issues/5000',
    # ]

    start_urls = ["https://github.com/tensorflow/tensorflow/issues/" + str(issue_num) for issue_num in range(44491, 58608)]
